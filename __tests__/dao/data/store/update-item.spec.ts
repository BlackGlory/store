...
import { getRawItem, setRawItem } from './utils.js'
...
describe('updateItem(namespace: string, id: string, type: string, payload: string): IRevision', () => {
  describe('it exists', () => {
    it('update item and return new revision', () => {
      ...
      const result = StoreDAO.updateItem(namespace, id, type, newPayload)
  ...
  describe('it does not exist', () => {
    it('throw NotFound', () => {
      ...
      const err = getError(() => StoreDAO.updateItem(namespace, id, type, payload))
...
`, () => {
  describe('it exists', () => {
    describe('correct revision', () => {
      it('update item and return new revision', () => {
        ...
        const result = StoreDAO.updateItemWithCheck(namespace, id, type, revision, newPayload)
        const updatedItem = getRawItem(namespace, id)
    ...
    describe('incorrect revision', () => {
      it('throw IncorrectRevision', () => {
        ...
        const result = getError(
          () => StoreDAO.updateItemWithCheck(namespace, id, type, 'bad-revision', newPayload)
        )
  ...
  describe('it does not exist', () => {
    it('throw NotFound', () => {
      ...
      const result = getError(() => StoreDAO.updateItemWithCheck(namespace, id, type, revision, payload))
